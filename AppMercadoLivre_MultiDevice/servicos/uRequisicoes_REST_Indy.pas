...
uses IdBaseComponent, IdComponent, IdTCPConnection, IdTCPClient, IdHTTP,
  ...
  uEPropriedadeRequisicao,uIRequisicoes_REST;

type
  TRequisicoes = class(TInterfacedObject, IRequisicoes_REST)
  private
...
begin
  ...
  IdSSL.SSLOptions.SSLVersions       := [sslvTLSv1,sslvSSLv2,sslvSSLv3];
